...
var ContextMenu = function () {
    ...
    ContextMenu.prototype.generateDOM = function generateDOM(e, ctxmenu, parentMenu) {
        var _this3 = this;
                            ...
                            if (item.subMenu.length === 0) {
                                ...
                                li.addEventListener("mouseenter", function (ev) {
                                    ...
                                    to = setTimeout(function () {
                                        return _this3.openSubMenu(ev, item.subMenu, li);
                                    }, 150);
                                });
                ...
                li.addEventListener("mouseenter", function (ev) {
                    ...
                    if (subMenu && subMenu !== li.querySelector("ul")) {
                        tout = setTimeout(function () {
                            return _this3.closeMenu(subMenu);
                        }, 150);
                    }
                });
                li.addEventListener("mouseleave", function () {
        ...
        if (parentMenu) {
            ...
            pos.y = e.target ? e.target.getBoundingClientRect().top - 4 : pos.y;
        }
