...
document.addEventListener("readystatechange", function (e) {
    if (document.readyState === "interactive") {
        ...
        styles.innerHTML = "ul.ctxmenu{border:1px solid #999;padding:2px 0;box-shadow:3px 3px 3px #aaa;background:#fff}ul.ctxmenu li{margin:1px 0;display:block}ul.ctxmenu li *{display:block;padding:2px 20px;cursor:default}ul.ctxmenu li a{color:inherit;text-decoration:none}ul.ctxmenu li.disabled{color:#aaa}ul.ctxmenu li.interactive:hover{background:rgba(0,0,0,0.1)}";
